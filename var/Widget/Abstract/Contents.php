...
class Widget_Abstract_Contents extends Widget_Abstract
{
    ...
    public function select()
    {
        ...
        'table.contents.template', 'table.contents.password', 'table.contents.allowComment', 'table.contents.allowPing', 'table.contents.thumb_url',  'table.contents.duration','table.contents.allowFeed','table.contents.videoId',
    ...
    public function insert(array $content)
    {
        ...
        $insertStruct = array(
            ...
            'thumb_url'        =>  empty($content['thumb_url']) ? NULL : intval($content['thumb_url'])
        );
