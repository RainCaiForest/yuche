...
class Widget_Contents_Related extends Widget_Abstract_Contents
{
    ...
    public function select()
    {
        ...
        'table.contents.template', 'table.contents.password', 'table.contents.allowComment', 'table.contents.thumb_url','table.contents.duration','table.contents.allowPing', 'table.contents.allowFeed','table.contents.videoId')
        ->from('table.contents');
    }
